...
export default function Footer() {
  return (
    <footer className="footer-section bg-[#05143a] text-white pt-12 relative w-full">
      {/* Top CTA Row */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="footer-logo mb-6 flex items-center">
            {/* If you have a logo: */}
            {/* <Image src="/images/logo.jpeg" alt="Mystic ArtWoods Logo" width={120} height={50} className="rounded bg-white" /> */}
